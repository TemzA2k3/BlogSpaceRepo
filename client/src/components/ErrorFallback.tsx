    ...
    <div className="flex items-center pt-[10rem] justify-center dark:bg-gray-900 px-4">
      ...
      >
        ...
        <h2 className="text-2xl sm:text-3xl font-semibold text-gray-800 dark:text-gray-200 mb-3">
          {t('errorBoundary.title', 'Произошла ошибка')}
        </h2>

        <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
          {t('errorBoundary.label', 'Что-то пошло не так. Попробуйте перезагрузить страницу или вернитесь позже.')}
        </p>
        ...
        {resetErrorBoundary && (
          ...
          >
            {t('errorBoundary.btnText', 'Попробовать снова')}
          </button>
        )}
