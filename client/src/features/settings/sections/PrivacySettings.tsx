...
import { SectionHeader, SettingGroup, SettingRow, SelectButton, Toggle } from "../components";
...
export const PrivacySettings: FC<PrivacySettingsProps> = ({ settings, updating, onUpdate }) => {
