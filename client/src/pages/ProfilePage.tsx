            ...
            >
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                    <div className="relative w-28 h-28">
                        <img
                            src={getAvatarUrl(userData.firstName, userData.lastName, userData.avatar)}
                    ...
                    <div className="flex-1 text-center sm:text-left">
                        ...
                        {isMyProfile ? (
                            ...
                            <div className="mt-6 flex gap-3 justify-center sm:justify-start">
                                <button className="px-5 py-2 rounded-xl bg-green-600 hover:bg-green-700 text-white font-medium transition">
                                    Follow
                                </button>
