    ...
    const features = [
        {
            ...
            title: "Публикуй посты",
            description: "Делись мыслями, идеями и новостями с друзьями и подписчиками",
        },
        {
            icon: "fa-newspaper",
            title: "Пиши статьи",
            description: "Создавай длинные материалы с форматированием и изображениями",
        },
        {
            icon: "fa-comments",
            title: "Общайся",
            description: "Обменивайся сообщениями в реальном времени с другими пользователями",
        },
        {
            icon: "fa-users",
            title: "Находи друзей",
            description: "Подписывайся на интересных людей и находи единомышленников",
        },
        {
            icon: "fa-hashtag",
            title: "Следи за трендами",
            description: "Узнавай о популярных темах через хештеги и рекомендации",
        },
        {
            icon: "fa-shield-halved",
            title: "Приватность",
            description: "Контролируй кто видит твой профиль и может писать тебе",
        },
    ];
        ...
        <div className="space-y-16">
            ...
            <section className="pt-8 sm:pt-12">
                ...
                >
                    ...
                    >
                        Место, где рождаются идеи. Делись мыслями, пиши статьи, 
                        находи единомышленников и создавай своё сообщество.
                    </motion.p>
            ...
            <section className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700">
                ...
                >
                    <StatItem value="10K+" label="Пользователей" />
                    <StatItem value="50K+" label="Публикаций" />
                    <StatItem value="100K+" label="Сообщений" />
            ...
            <section>
                ...
                >
                    ...
                    >
                        BlogSpace объединяет лучшие функции социальных сетей и блог-платформ
                    </motion.p>
                </motion.div>
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-neutral-400 mb-8 max-w-md mx-auto">
                            Создай аккаунт бесплатно и начни делиться своими идеями уже сегодня
                        </p>
